...
__near __mem_y void register __i0 *memcpyXY (__near __mem_y void register __i0 *
                                             d,
                                             __near const void register __i1 *
                                             s, size_t register __a0 n);
...
__near void register __i0 *memcpyYX (__near void register __i0 * d,
                                     __near __mem_y const void register __i1 *
                                     s, size_t register __a0 n);
                                     /**< Copies n words from s to d, where the source is in Y memory. Returns a pointer to d. */
__near __mem_y void register __i0 *memcpyYY (__near __mem_y void register __i0 *
                                             d,
                                             __near __mem_y const void register
                                             __i1 * s, size_t register __a0 n);
...
__near void memcpyii (__near void register __i0 * d,
                      __near const void register __i1 * s,
                      size_t register __a0 n);
                                  /**< Copies n instruction words from s to d, where both the source and the destination is in I memory. The memory areas should not overlap. */
__near void memmoveii (__near void register __i0 * d,
                       __near const void register __i1 * s,
                       size_t register __a0 n);
                                  /**< Copies n instruction words from s to d, where both the source and the destination is in I memory. The memory areas can overlap. */
...
__near void register __i0 *memchr (__near const void register __i0 * cs,
                                   int register __a0 c, size_t register __a1 n);
__near void register __i0 *memset (__near void register __i0 * s,
                                   int register __a1 c, size_t register __a0 n);
...
void memswapy (register __i0 __mem_y void *a, register __i1 __mem_y void *b,
               register __a0 size_t size);
                                    /**< Swaps two memory ares, both are in Y memory. The size gives the length of the area. */
void memswapxy (register __i0 void *a, register __i1 __mem_y void *b,
                register __a0 size_t size);
                                   /**< Swaps two memory ares, the secondis in Y memory. The size gives the length of the area. */
...
__near void MemCopyPackedBigEndianYX (register __i0 __near unsigned short *dst,
                                      register __a0 unsigned short dstbyteidx,
                                      register __i1 __near __mem_y unsigned
                                      short *src,
                                      register __a1 unsigned short srcbyteidx,
                                      register __b0 unsigned short byteSize);
/** Copies bytes from one word buffer in X to another in Y memory. The bytes
    ...
    When using non-aligned  start or end, the other half of the word retains
    its old value.  */
__near void MemCopyPackedBigEndianXY (register __i0 __near __mem_y unsigned
                                      short *dst,
                                      register __a0 unsigned short dstbyteidx,
                                      register __i1 __near unsigned short *src,
                                      register __a1 unsigned short srcbyteidx,
...
/** Copies bytes from one word buffer in Y to another in Y memory. The bytes
    ...
    value.  */
__near void MemCopyPackedBigEndianYY (register __i0 __near __mem_y unsigned
                                      short *dst,
                                      register __a0 unsigned short dstbyteidx,
                                      register __i1 __near __mem_y unsigned
                                      short *src,
...
/** Scales a vector by shifting the amount specified. If shift is positive,
    ...
    or zero. */
void ShiftSatVector (register __i0 short *vector, register __a0 short elements,
                     register __a1 short shift);
#endif /* _STRING_H_ */
