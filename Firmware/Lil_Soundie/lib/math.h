...
__near auto unsigned long SqrtI32 (register __c unsigned long x); /* 16.16
                                                                   * result */
...
__near short logdb (register __b0 unsigned short x);  /* returns approximate
                                                       * decibels, -96 for 0
                                                       * and 1, about 45 cycles 
                                                       */
__near short logdb32 (register __b unsigned long x);  /* returns approximate
                                                       * decibels, 0 for 0 and
                                                       * 1, 192 for max, uses
                                                       * logdb, about 62 cycles 
                                                       */
#else
